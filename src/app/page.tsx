...
export default function HomePage() {
  ...
  const placeSlug = searchParams.get('place') ?? 'fridge'; // 기본값: fridge
  ...
  // 2) 최신 로그 30개 조회 (household + place 기준)
      ...
      >
        <header style={{ marginBottom: 20 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 12 }}>
              <Link href="/qr" style={{ color: '#38bdf8', textDecoration: 'none', marginRight: 12 }}>QR코드</Link>
              <Link href="/invite" style={{ color: '#38bdf8', textDecoration: 'none' }}>가족초대</Link>
            </div>
          </div>
        ...
        {!user && (
          <div style={{ fontSize: 13, color: '#cbd5f5' }}>
            ...
            하거나, 가족 초대 링크로{' '}
            <Link href="/join" style={{ color: '#38bdf8', textDecoration: 'none' }}>참여</Link>
            하세요.
          </div>
        )}
