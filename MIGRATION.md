...
- **주요 파일**: `src/app/HomeClient.tsx` (메인 UI·상태), `src/lib/logTags.ts` (슬러그·필터), `src/lib/logMedia.ts` (`getLogMedia`), `src/lib/formatDateTime.ts`, `src/components/home/LogTagFilterRow.tsx`, `LogFeed.tsx`, `CommentSheet.tsx`, `StickerPickerSheet.tsx`, `NameEditModal.tsx`, `src/app/globals.css`, `src/app/translations.ts`
